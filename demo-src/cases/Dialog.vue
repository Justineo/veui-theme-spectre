<template>
  <article class="demo-dialog">
    ...
    <section>
      ...
      <veui-dialog
        ...
        <template slot="foot" slot-scope="{ close }">
          ...
          <veui-button ui="link" autofocus @click="close">CANCEL</veui-button>
        </template>
      </veui-dialog>
      <veui-button ui="primary"
    ...
    <section>
      ...
      <veui-button @click="draggableDialog3Visible = !draggableDialog3Visible">Draggable dialog box with reset button</veui-button>
    </section>
    <section>
      <veui-dialog
    ...
    <section>
      <veui-dialog
        ...
        ui="lg"
        title="Custom Title">
        <p>You can change the dialog title text by setting the `title` prop or passing in the `title` slot parameter.</p>
        <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Dolorem eveniet saepe expedita eaque, unde libero? Illo nihil laborum vel molestiae! Eum fugit dignissimos tempora voluptatum facilis earum, illo dicta odio.</p>
        <template slot="foot">
          <veui-button ui="primary" @click="customTextTitleDialogVisible = false">OK</veui-button>
          <veui-button ui="link" autofocus @click="customTextTitleDialogVisible = false">CANCEL</veui-button>
        </template>
      </veui-dialog>
      ...
      <veui-dialog
        ...
        <template slot="title">Custom Title With ICON <veui-icon class="svg" name="info"/></template>
        <template slot="foot">
          <veui-button ui="primary" @click="customIconTitleDialogVisible = false">OK</veui-button>
          <veui-button ui="link" autofocus @click="customIconTitleDialogVisible = false">CANCEL</veui-button>
        </template>
    ...
    <section>
      <veui-dialog
        ...
        <template slot="foot">
          ...
          <veui-button ui="link" autofocus @click="contentAutoHeightDialogVisible = false">CANCEL</veui-button>
        </template>
      </veui-dialog>
...
import Vue from 'vue'
import 'vue-awesome-material-icons/icons/calendar_today_outlined'
