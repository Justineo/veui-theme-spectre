<template>
  <article>
    ...
    <p><veui-radio-group ui="inline" v-model="trigger" :items="triggers"/></p>
    <p><veui-radio-group ui="inline" v-model="size" :items="sizes"/></p>
    <p><veui-radio-group ui="inline" v-model="indicator" :items="indicators"/></p>
    <section>
