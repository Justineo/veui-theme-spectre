  ...
  <article>
    ...
    <veui-form>
      <section class="five-sizes">
        <h3>3 种大小：</h3>
        <veui-field ui="sm" label="sm">
          <veui-input ui="sm" v-model="poem"/>
        </veui-field>
        <veui-field label="normal">
          <veui-input v-model="poem"/>
        </veui-field>
        <veui-field ui="lg" label="lg">
          <veui-input ui="lg" v-model="poem"/>
        </veui-field>
      </section>
      ...
      <section>
        ...
        <veui-field label="描述：">
            ...
            <veui-input v-model="key" composition readonly placeholder="默认不感知输入法，这里感知"/>
            <veui-input composition v-model="key" :disabled="true" placeholder="默认不感知输入法，这里感知"/>
        </veui-field>
