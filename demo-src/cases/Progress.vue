<template>
  <article>
    ...
    <section>
      <h2>线性进度条</h2>
      <veui-progress :value="Number(progress)" desc :auto-succeed="200" :status.sync="status" :decimal-place="1"/>

      <h3>加载中状态</h3>
      <div style="width: 10em;">
        <veui-progress indeterminate/>
      </div>
    </section>
    <section>
      <h2>环形进度条</h2>
      <veui-progress type="circular" :value="Number(progress)" desc :auto-succeed="200" :status.sync="status"/>
    </section>
  </article>
</template>
